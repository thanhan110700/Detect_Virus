...
# Danh sách duy trì số lượng để xoay bộ đệm trong giai đoạn xử lý
rotate_by = [7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22,
             5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20, 5, 9, 14, 20,
             4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23,
             6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21, 6, 10, 15, 21]

# Danh sách này duy trì hằng số phụ sẽ được thêm vào trong mỗi bước xử lý.
...
def getHash(filename):
    ...
    message_hash = MD_to_hex(processed_msg) #This is Result
